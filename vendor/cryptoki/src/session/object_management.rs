...
impl Session {
    ...
    pub fn get_attributes(
        ...
        let mut buffers: Vec<zeroize::Zeroizing<Vec<u8>>> = Vec::with_capacity(attributes.len());
        ...
        for attr_type in attributes.iter() {
            if let Some(size) = attr_type.fixed_size() {
                ...
                let buffer = zeroize::Zeroizing::new(vec![0u8; size]);
                ...
                buffers.push(zeroize::Zeroizing::new(Vec::new()));
            }
        }
