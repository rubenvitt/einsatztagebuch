...
- **Merker Web-Reader**, `docs/superpowers/specs/2026-08-15-einsatzarchiv-web-reader-design.md` §12: Task 8 dieses Plans schaltet nur noch Writer und Administration frei — der Reader ist eine Browser-PWA und nicht mehr Teil der Desktopanwendung. Neu erforderlich ist ein Task für den Export eines Archiv-Bündels als **eine Datei**, damit der Datei-Modus des Web-Readers (§5.2) in allen unterstützten Browsern funktioniert; `showDirectoryPicker` ist in Safari und Firefox nicht verfügbar, der universelle Weg MUSS daher immer angeboten werden.
